      ...
      <div className="p6 bg-white min-w-220 relative w-full h-full overflow-hidden">
        ...
        <div className="flex justify-center gap-x-6 w-full">
          ...
          <div className="flex flex-col items-center justify-center gap-y-0.5 mb-1 mt-4">
            ...
            <div className="border-2 py-1 px-2 mt-1 bg-gray-200 text-[16px] uppercase">
        ...
        <div className="space-y-2 text-[13px] mb-4">
          ...
          {(() => {
            ...
            return lines?.map((line, index) => (
              <div
                key={index}
                className="border-b-2 border-dotted border-black min-h-3 py1 text-gray-600"
              >
                {line || "\u00A0"}
              </div>
            ));
        ...
        <div className="mb-4">
          <div className="flex items-end">
            <span className="text-[13px] mr-2">For which the NCAA</span>
            <div className="flex-1 border-b-2 border-dotted border-black h-6">
              {jobOrderData?.DEPARTMENT_SUPPLIED}
            </div>
            <span className="text-[13px] ml-2">Agreed to pay the sum of</span>
          </div>
          <div className="flex items-center mt-1">
            <div className="flex-1"></div>
            <span className="text-[13px] mr-2">(Department/Unit)</span>
          </div>
          <div className="flex items-center justify-end mt-2 space-x-4">
            ...
            <div className="border-b-2 border-dotted border-black w-24 h-4"></div>
          </div>
        </div>

        {/* Signature Section */}
        <div className="border-t-2 border-black pt4 mb-3">
          ...
          <div className="space-y-6">
            <div className="flex justify-between">
              <div>
                ...
                <div className="border-b-2 border-dotted border-black w-64"></div>
              </div>
              <div>
